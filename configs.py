...
class Configs:
    ...
    CHANNEL_LINK = getenv("CHANNEL_LINK", "https://t.me/RowlynBotUpdatesKanal")
    GROUP_LINK = getenv("GROUP_LINK", "https://t.me/RowlynBotUpdatesGrub")
    UPSTREAM_REPO = getenv("UPSTREAM_REPO", "https://github.com/RowLyn")
